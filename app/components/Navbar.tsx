        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            <div className="space-x-4">
              <Link href="/login" className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-indigo-600 bg-white hover:bg-gray-50">
                Login
              </Link>
      ...
      {mobileMenuOpen && (
        <div className="sm:hidden">
          <div className="pt-2 pb-3 space-y-1">
            ...
            <Link href="/modules" className="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
              IELTS Modules
            </Link>
          ...
          <div className="pt-4 pb-3 border-t border-gray-200">
            <div className="space-y-1">
              ...
              <Link href="/register" className="block px-4 py-2 text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                Start Free Trial
              </Link>
            </div>
          </div>
