        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    Continue your IELTS preparation journey. Your current
                    overall progress is {userData.progress.overall}%.
                  </p>
                </div>
            ...
            <div className="hidden sm:block">
              <div className="border-b border-gray-200">
                <nav className="-mb-px flex space-x-8" aria-label="Tabs">
                  {(
                    ["overview", "progress", "materials", "tests"] as TabType[]
                  ).map((tab) => {
                  ...
                  {Object.entries(userData.progress)
                    ...
                    .map(([module, progress]) => {
                      ...
                      return (
                        <div
                          key={module}
                          className={`bg-white overflow-hidden rounded-lg shadow ${colors.border}`}
                        >
                          <div className="p-5">
                            <div className="flex items-center">
                              <div
                                className={`flex-shrink-0 rounded-md p-3 ${colors.bg}`}
                              >
                                <svg
                ...
                <div className="bg-white shadow overflow-hidden sm:rounded-md">
                  <ul className="divide-y divide-gray-200">
                    {userData.recentActivity.map((activity) => {
                      const moduleKey =
                        activity.module as keyof typeof moduleColors;
                      const colors = moduleColors[moduleKey];
                        ...
                        <li key={activity.id}>
                          ...
                          >
                            <div className="px-4 py-4 flex items-center sm:px-6">
                              <div
                                className={`flex-shrink-0 h-10 w-10 rounded-full ${colors.bg} flex items-center justify-center`}
                              >
                                <svg
                                  className={`h-6 w-6 ${colors.icon}`}
                                  fill="none"
                  ...
                  <div className="bg-white shadow overflow-hidden rounded-lg">
                    <ul className="divide-y divide-gray-200">
                      {userData.recommendedContent.map((content) => {
                        const moduleKey =
                          content.module as keyof typeof moduleColors;
                        const colors = moduleColors[moduleKey];
                      ...
                      <div>
                        ...
                        <div className="mt-2 max-w-xl text-sm text-gray-500">
                          <p>
                            ...
                            .
                            {userData.subscription.status === "active" &&
                              ` Next billing date is ${userData.subscription.nextBillingDate}.`}
                          </p>
                        </div>
                      </div>
          ...
          {activeTab === "progress" && (
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                This tab would show detailed progress tracking and analytics.
              </p>
            </div>
          )}
          ...
          {activeTab === "materials" && (
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                This tab would provide access to all learning materials and
                resources.
              </p>
            </div>
          )}
          ...
          {activeTab === "tests" && (
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                This tab would provide access to all practice tests and
                assessments.
              </p>
            </div>
          )}
