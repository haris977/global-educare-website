...
const listeningLevels = [
  {
    ...
    description:
      "Introduction to IELTS listening with simple exercises focused on everyday conversations and basic instructions.",
    topics: [
    ...
    sampleContent: {
      ...
      description:
        "A conversation between a customer and a waiter about placing an order at a restaurant.",
    },
  },
  {
    level: "Intermediate (Bands 5.5-6.5)",
    description:
      "More challenging listening exercises featuring a wider range of accents and more complex conversations in various settings.",
    topics: [
    ...
    sampleContent: {
      ...
      description:
        "A guide explaining facilities and services available on a university campus to new students.",
    },
  },
  {
    level: "Advanced (Bands 7.0-9.0)",
    description:
      "Complex listening tasks featuring academic lectures, group discussions, and content with challenging vocabulary and regional accents.",
    topics: [
    ...
    sampleContent: {
      ...
      description:
        "A panel of experts discussing the environmental and economic impacts of climate change policies.",
    },
  },
];
...
const tips = [
  {
    ...
    description:
      "Make sure you understand exactly what you need to do for each section before the audio begins.",
  },
  {
    title: "Preview the questions",
    description:
      "Use the time given before each section to read through the questions and predict what the answers might be.",
  },
  {
    title: "Listen for signpost words",
    description:
      "Pay attention to transition words like 'however,' 'furthermore,' and 'in conclusion' which signal important information.",
  },
  {
    title: "Watch for distractors",
    description:
      "The audio may contain information that seems to answer a question but is then corrected or clarified later.",
  },
  {
    title: "Check your spelling",
    description:
      "In the IELTS Listening test, spelling errors are marked as incorrect, so double-check your answers.",
  },
  {
    title: "Write answers as you listen",
    description:
      "Don't wait until the end to write down your answers - you might forget them.",
  },
];
        ...
        <div className="relative bg-blue-700">
          ...
          <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            ...
            <p className="mt-6 max-w-3xl text-xl text-white">
              Improve your ability to understand spoken English with various
              accents and in different contexts, from everyday conversations to
              academic lectures.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              ...
              <p className="mt-4 max-w-3xl mx-auto text-xl text-gray-700">
                Experience a real IELTS Listening test with our interactive
                sample. Listen to the audio and answer the questions.
              </p>
              <div className="mt-4 text-sm text-blue-700 bg-blue-50 p-4 rounded-md inline-block border border-blue-100">
                ...
                <ul className="mt-2 text-left list-disc pl-5 space-y-1">
                  <li>
                    Click the{" "}
                    <span className="font-semibold">blue play button</span> to
                    start the audio
                  </li>
                  <li>
                    Use the <span className="font-semibold">volume slider</span>{" "}
                    if needed to adjust sound level
                  </li>
                  <li>
                    The audio will only play{" "}
                    <span className="font-semibold">once</span>, just like in
                    the real test
                  </li>
                </ul>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
              <div>
                ...
                <p className="mt-3 max-w-3xl text-lg text-gray-700">
                  The IELTS Listening test takes approximately 30 minutes, with
                  an additional 10 minutes to transfer your answers to the
                  answer sheet. It consists of four sections, each with ten
                  questions.
                </p>
        ...
        <div className="bg-white py-16 sm:py-24 border-t border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-4 max-w-3xl mx-auto text-xl text-gray-700">
                Our listening materials are categorized by difficulty to help
                you progressively build your skills toward your target band
                score.
              </p>
            </div>
        ...
        <div className="bg-gray-50 py-16 sm:py-24 border-t border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-4 max-w-3xl mx-auto text-xl text-gray-700">
                Improve your IELTS Listening score with these proven strategies
          ...
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            ...
            <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
              <div className="inline-flex rounded-md shadow">
                <Link
                  href="/register"
                  className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-blue-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white"
                >
                  Start Free Trial
                </Link>
              </div>
              <div className="ml-3 inline-flex rounded-md shadow">
                <Link
                  href="/modules"
                  className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600"
                >
