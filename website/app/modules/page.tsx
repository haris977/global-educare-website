...
const modules = [
  ...
  },
  {
    ...
    title: "Reading",
    description:
      "Develop critical reading skills for academic texts and enhance your vocabulary.",
    completedLessons: 5,
    totalLessons: 22,
    color: "purple",
    icon: (
  ...
  },
  {
    ...
    title: "Writing",
    description:
      "Learn to write clear, well-structured responses for both academic and general tasks.",
    completedLessons: 3,
    totalLessons: 18,
    color: "green",
    icon: (
  ...
  },
  {
    ...
    title: "Speaking",
    description:
      "Build confidence in expressing your ideas clearly and fluently in an English-speaking environment.",
    completedLessons: 2,
    totalLessons: 16,
    color: "yellow",
    icon: (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-gray-700">
                  Access comprehensive learning materials and practice exercises
                  for all four IELTS test modules.
                </p>
              </div>
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="mt-4 max-w-2xl">
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                  {modules.map((module) => {
                    const colors =
                      moduleColors[module.color as keyof typeof moduleColors];
                    ...
                    return (
                      <div
                        key={module.id}
                        className={`${colors.bg} ${colors.border} border rounded-lg px-4 py-3`}
                      >
          ...
          <div className="mt-12 bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Based on your learning history and progress
              </p>
            </div>
            <div className="border-t border-gray-200">
              <ul className="divide-y divide-gray-200">
                <li>
                  <Link
                    href="/modules/listening/lessons/academic-lectures"
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <p className="text-sm font-medium text-indigo-600 truncate">
                              Academic Lectures: Note-Taking Skills
                            </p>
                            <p className="mt-1 text-sm text-gray-500">
                              Listening Module • Advanced • 25 min
                            </p>
                          </div>
                        </div>
                ...
                <li>
                  <Link
                    href="/modules/writing/lessons/task2-opinion"
                    className="block hover:bg-gray-50"
                  >
                    <div className="px-4 py-4 sm:px-6">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <p className="text-sm font-medium text-indigo-600 truncate">
                              Task 2: Structuring Opinion Essays
                            </p>
                            <p className="mt-1 text-sm text-gray-500">
                              Writing Module • Intermediate • 40 min
                            </p>
                          </div>
                        </div>
                        <div className="ml-2 flex-shrink-0 flex">
                    ...
                    <div className="px-4 py-4 sm:px-6">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <p className="text-sm font-medium text-indigo-600 truncate">
                              Mini Practice Test: Reading
                            </p>
                            <p className="mt-1 text-sm text-gray-500">
                              Reading Module • Mixed Difficulty • 30 min
                            </p>
                          </div>
                        </div>
                        <div className="ml-2 flex-shrink-0 flex">
